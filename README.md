...
Утилитный CLI-бот для поиска объявлений и проверки нарушений на LZT Market. Работает на Node.js 18+ и поддерживает 7 режимов поиска, SQLite-историю, Telegram-уведомления, веб-просмотр и экспорт в Excel.
